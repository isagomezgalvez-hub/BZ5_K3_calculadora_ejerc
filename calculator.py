...
class Controlator(ttk.Frame):
    def __init__(self, parent):
        ...
        for properties in dbuttons:
            btn = Call_Buton(self, properties['text'], d.paint, properties.get(
                "W", 1), properties.get("H", 1))
            btn.grid(column=properties['col'], row=properties['row'], columnspan=properties.get(
                "W", 1), rowspan=properties.get("H", 1))
...
class Display(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.lbl = ttk.Label(self, text=self.value,
                             anchor=E, style='my.TLabel')
